...
class AdminTasksDet extends Component {
    constructor(props){
        super(props)
  ...
  <div className="col_dash_2_90_project_det">
      ...
      <div className="col_dash_2_90_project_det_col_det">
        <tr className="tr_deatils_project">
            <td>Task ID</td>
            <td>:</td>
            <td><Link to="/adminTasksDetails">{task_id}</Link></td>
        </tr>
        <tr className="tr_deatils_project">
            <td>Task Name</td>
            <td>:</td>
        ...
        <tr className="tr_deatils_project">
            <td>Assigned To</td>
            <td>:</td>
            <td><Link to="/adminUserProfile">{assigned_name}</Link></td>
        </tr>
        <tr className="tr_deatils_project">
            <td>Risk Rating</td>
            <td>:</td>
        ...
        <tr className="tr_deatils_project">
            <td>Reassign Task</td>
            <td>:</td>
            <td><button onClick={this.openhiddenform}>Reassign</button></td>
        </tr>
        <tr className="tr_deatils_project">
            <td>Delete Task</td>
            <td>:</td>
