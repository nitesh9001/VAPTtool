...
class Discussion extends Component {
  ...
  open_Mcopy=e=>{
    e.preventDefault();
    const {openMcopy,openMsg}=this.state;
    this.setState({openMcopy:!openMcopy,openMsg:!openMsg});
  }
 onopengroup=(e)=>{
  e.preventDefault();
...
return ( 
  ...
  <div className="col_dash_2_90_d" id="blur_back">
    ...
    <Tabs className="col_dash_discussion_left">
     ...
     <div className="col_dash_discussion_left_mid_inner">
     <button className="btn_common_info side_icon" onClick={this.open_Mcopy}><span className="tool-tip">M-Rec</span><i className="fa fa-bookmark"  id="active_icons_5" aria-hidden="true"></i></button>
     </div>
     <div className="col_dash_discussion_left_btm">
